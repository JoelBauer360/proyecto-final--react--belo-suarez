        ...
        <div className="container marketing">
          <div className="row mx-auto align-middle text-center py-4">
            <div className="col-lg-4 mx-auto">
              ...
              <h2>Nuestro Cheff <p>Enrique Altallanta</p></h2>
              <p>Nuestro cheff Enrique Altallanta estudió en Londres para luego regresar a nuestras tierras y encontrarse con "la dueña" y fundar Habemus Papa! Foodtruck.</p>
            ...
            <div className="col-lg-4 mx-auto">
              ...
              <h2>Nuestro otro cheff <p>Lionel Andres Cucittini</p></h2>
              <p>El Cheff Cucittini, recibido de la mejor escuela de cocina de Italiana, viajó para visitar nuestro país y se quedó a vivir por la comida.</p>
              <p><Link to="" className="btn btn-secondary">Más info »</Link></p>
            </div>
            <div className="col-lg-4">
              <img src={owner} className="img-fluid mx-auto" alt="dueñadehabemuspapamaríaeugeniavidal" />
              <h2>Nuestra estrella<p>Miranda Cosgrove</p></h2>
              <p>Miranda es la dueña de Habemus Papa! y con todos sus ahorros se compró un foodtruck hace varios años para fundar Habemus Papa! Foodtruck.</p>
              <p><Link to="" className="btn btn-secondary">Más info »</Link></p>
            </div>
          </div>
          {/* Nuestra ética */}
